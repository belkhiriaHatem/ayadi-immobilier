...
export function GallerySection() {
  ...
  const images = [
    { src: "/images/mono-1.png", alt: "Hall d'entrée — boiseries et marbre" },
    { src: "/images/mono-2.png", alt: "Salon lumineux — Résidence Ayadi" },
    { src: "/images/mono-3.png", alt: "Détails architecturaux — éclairage doré" },
    { src: "/images/mono-4.png", alt: "Espace de vie contemporain" },
  ];
  ...
  return (
    <section 
      ...
      style={{ minHeight: `${(images.length + (isMobile ? 0.5 : 1)) * 100}vh` }}
    >
      {/* Sticky container */}
      <div className="sticky top-0 flex h-[100dvh] items-center justify-center overflow-hidden px-3 sm:px-4">
        <div className="relative h-[62vh] w-full max-w-5xl sm:h-[70vh] md:h-[80vh]">
