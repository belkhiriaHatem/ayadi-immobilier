...
export function PhilosophySection() {
  ...
  return (
    <section id="products" className="bg-background">
      ...
      <div ref={sectionRef} className="relative" style={{ height: isMobile ? "140vh" : "200vh" }}>
              ...
              <div className="relative w-full" style={{ transformStyle: 'preserve-3d', minHeight: '150px' }}>
                {titles.map((title, index) => {
                  ...
                  return (
                    <h2 
                      key={index}
                      className="absolute inset-0 flex items-center justify-center px-4 text-center text-[9vw] font-medium leading-tight tracking-tighter text-foreground sm:text-[7vw] md:text-[6vw] lg:text-[5vw]"
                      style={{
      ...
      <div ref={descriptionRef} className="px-6 pt-8 pb-20 md:px-12 md:pt-12 md:pb-28 lg:px-20 lg:pt-16 lg:pb-36">
        <div className="text-center">
          ...
          <p className="mt-6 text-center text-lg leading-relaxed text-muted-foreground sm:mt-8 sm:text-xl md:text-2xl lg:text-3xl">
            {("La Société Anouar Ayadi conçoit des résidences d'exception où marbre, bois noble et éclairage d'ambiance se rencontrent. Chaque espace est pensé pour offrir confort, élégance et un art de vivre raffiné.").split(" ").map((word, index, array) => {
